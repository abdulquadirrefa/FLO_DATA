...
const { GRNLogin }                  = require('../pages/GRNLogin');
const { WarehouseSelectionPage }    = require('../pages/WarehouseSelectionPage');
const { PLCreationPage }            = require('../pages/PLCreationPage');
const { PLOverviewPage }            = require('../pages/PLOverviewPage');
const { InventoryViewPage }         = require('../pages/InventoryViewPage');
const { DeviceLoginPage }           = require('../pages/DeviceLoginPage');
const { DeviceScanPage }            = require('../pages/DeviceScanPage');
const { ConfirmGRNPage }            = require('../pages/ConfirmGRNPage');
