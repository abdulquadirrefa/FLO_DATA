// ═════════════════════════════════════════════════════════════════════════════
//  Regression – Master PO Planning – Reversal Flow
//  Adapted from tests/flo/master-po-reverse.spec.js for the regression suite:
...
//    • Test data lives in data/regression/master-po-reverse.data.json.
//
...
const data             = require('../../data/regression/master-po-reverse.data.json');
...
test('Master PO Planning – Reversal Flow', async ({ page }) => {
  ...
  await test.step('Step 5R – Delete Component Group Assignment', async () => {
    try {
      ...
      console.log('\n' + '═'.repeat(60));
      console.log('  REGRESSION – REVERSAL FLOW COMPLETE');
