...
const { FloLoginPage }    = require('../flo-smoke/pages/FloLoginPage');
const { FloSidebarPage }  = require('../flo-smoke/pages/FloSidebarPage');
const { PPSMasterPOPage } = require('../flo-smoke/pages/PPSMasterPOPage');
